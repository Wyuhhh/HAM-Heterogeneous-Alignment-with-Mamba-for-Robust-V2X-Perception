...
def project_world_objects_airv2x(
    ...
    order : str
        'lwh' or 'hwl'
    """
    # AirV2X class mapping: filter non-vehicle classes and remap 1-6 to 0-5
    # Original: 1=car, 2=motorcycle, 3=bicycle, 4=van, 5=truck, 6=bus, 8=pedestrian, 9=other
    # Target: 0=car, 1=motorcycle, 2=bicycle, 3=van, 4=truck, 5=bus
    VALID_CLASSES = {1, 2, 3, 4, 5, 6}  # Only vehicle classes
    ...
    for object_id, object_content in object_dict.items():
        ...
        # Filter out non-vehicle classes (8=pedestrian, 9=other, etc.)
        if class_id not in VALID_CLASSES:
            continue
        
        # Remap class_id from 1-6 to 0-5
        class_id = class_id - 1
